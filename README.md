...
## Installer spaCy 2.3.5 et stanza 1.2.1

Ces versions de spaCy et stanza s'utilisent dans un environnement python =<3.7

```bash
pip install cymem==2.0.2 murmurhash==1.0.2 preshed==3.0.2
pip install spacy==2.3.5
pip install stanza==1.2.1
#Installer les modèles de langues adéquats
```
...
```
Pour installer le modèle français de stanza écrire dans le script python : 
